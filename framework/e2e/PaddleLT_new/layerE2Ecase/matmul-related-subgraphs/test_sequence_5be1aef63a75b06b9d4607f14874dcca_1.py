...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t11
            paddle.to_tensor([0.13753941655158997, 0.04078058525919914, 0.3665136396884918], dtype='float32').reshape([3]),
            # t12
            paddle.uniform([1024, 4], dtype='float32', min=0, max=0.5),
            # t13
            paddle.to_tensor([0.08142861723899841, 0.03749847039580345, 0.2078557014465332, 0.36625242233276367], dtype='float32').reshape([4]),
        ]
