...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10):
        ...
        t11 = paddle._C_ops.conv2d(t0, t1, [1, 1], [2, 2], 'EXPLICIT', [1, 1], 4, 'NCHW')
        del t1
        ...
        t24 = paddle._C_ops.matmul(t23, t7, False, False)
        del t7
        
        # pd_op.add: (4x1280x128xf32) <- (4x1280x128xf32, 128xf32)
        t25 = paddle._C_ops.add(t24, t8)
        del t8
        ...
        # pd_op.layer_norm: (4x1280x128xf32, 4x1280xf32, 4x1280xf32) <- (4x1280x128xf32, 128xf32, 128xf32)
        t27, t28, t29 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t26, t9, t10, float('1e-06'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t10, t9
        
        # pd_op.transpose: (4x128x1280xf32) <- (4x1280x128xf32)
        t30 = paddle._C_ops.transpose(t27, [0, 2, 1])
        del t27
        ...
        return t11, t13, t14, t15, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t28, t29, t30, t32

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[4, 128, 16, 80], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([4, 128, 16, 80], dtype='float32', min=0, max=0.5),
            # t1
