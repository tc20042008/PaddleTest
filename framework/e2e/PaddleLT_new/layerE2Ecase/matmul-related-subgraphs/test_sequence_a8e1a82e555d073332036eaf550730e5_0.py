...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10):
        t1 = paddle._C_ops.full_int_array([0, -1, 256], paddle.int64, paddle.core.CPUPlace())
        t11 = None
        ...
        # pd_op.dropout: (-1x-1x256xf32, -1x-1x256xui8) <- (-1x-1x256xf32, None, 1xf32)
        ...
        # pd_op.add: (-1x40x256xf32) <- (-1x40x256xf32, -1x-1x256xf32)
        t18 = paddle._C_ops.add(t4, t16)
        del t16, t4
        
        # pd_op.layer_norm: (-1x40x256xf32, -1x40xf32, -1x40xf32) <- (-1x40x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (-1x40x512xf32) <- (-1x40x256xf32, 256x512xf32)
        t22 = paddle._C_ops.matmul(t19, t7, False, False)
        del t19, t7
        
        # pd_op.add: (-1x40x512xf32) <- (-1x40x512xf32, 512xf32)
        t23 = paddle._C_ops.add(t22, t8)
        del t22, t8
        
        # pd_op.swish: (-1x40x512xf32) <- (-1x40x512xf32)
        t24 = paddle._C_ops.swish(t23)
        del t23
        
        # pd_op.dropout: (-1x40x512xf32, -1x40x512xui8) <- (-1x40x512xf32, None, 1xf32)
        ...
        # pd_op.matmul: (-1x40x256xf32) <- (-1x40x512xf32, 512x256xf32)
        t27 = paddle._C_ops.matmul(t25, t9, False, False)
        del t25, t9
        
        # pd_op.add: (-1x40x256xf32) <- (-1x40x256xf32, 256xf32)
        t28 = paddle._C_ops.add(t27, t10)
        del t27, t10
        
        # pd_op.dropout: (-1x40x256xf32, -1x40x256xui8) <- (-1x40x256xf32, None, 1xf32)
    ...
    def get_input_spec(self):
        return [
            ...
            # t4
            paddle.static.InputSpec(shape=[None, 40, 256], dtype='float32'),
            # t5
            paddle.static.InputSpec(shape=[256], dtype='float32'),
            # t6
            paddle.static.InputSpec(shape=[256], dtype='float32'),
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([8, 40, 8, 32], dtype='float32', min=0, max=0.5),
            # t1
            ...
            # t4
            paddle.uniform([8, 40, 256], dtype='float32', min=0, max=0.5),
            # t5
            paddle.uniform([256], dtype='float32', min=0, max=0.5),
            # t6
            paddle.uniform([256], dtype='float32', min=0, max=0.5),
