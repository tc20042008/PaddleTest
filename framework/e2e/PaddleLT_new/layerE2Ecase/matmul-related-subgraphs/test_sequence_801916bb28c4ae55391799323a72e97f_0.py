...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        ...
        t9, t10, t11 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t8, t2, t3, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t3, t2
        ...
        # pd_op.add: (64x3136x96xf32) <- (64x3136x96xf32, 64x3136x96xf32)
        t17 = paddle._C_ops.add(t8, t16)
        
        return t8, t9, t10, t11, t12, t13, t14, t15, t16, t17
