...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10):
        ...
        t13 = paddle._C_ops.transpose(t12, [0, 2, 3, 1])
        del t12
        
        # pd_op.layer_norm: (-1x28x28x192xf32, -1x28x28xf32, -1x28x28xf32) <- (-1x28x28x192xf32, 192xf32, 192xf32)
        t14, t15, t16 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t13, t3, t4, float('1e-06'), 3), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t4, t3, t13
        
        # pd_op.matmul: (-1x28x28x768xf32) <- (-1x28x28x192xf32, 192x768xf32)
        t17 = paddle._C_ops.matmul(t14, t5, False, False)
        del t14, t5
