...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4):
        ...
        t5 = paddle._C_ops.flatten(t0, 1, 3)
        del t0
        ...
        return t5, t6, t8, t9, t11

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[2048, 256, 7, 7], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([2048, 256, 7, 7], dtype='float32', min=0, max=0.5),
            # t1
