...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13):
        ...
        t32 = paddle._C_ops.matmul(t31, t11, False, False)
        del t11
        
        # pd_op.add: (64x14x14x384xf32) <- (64x14x14x384xf32, 384xf32)
        t33 = paddle._C_ops.add(t32, t12)
        del t12
        
        # pd_op.multiply: (64x14x14x384xf32) <- (384xf32, 64x14x14x384xf32)
        t34 = paddle._C_ops.multiply(t13, t33)
        del t13
        
        # pd_op.transpose: (64x384x14x14xf32) <- (64x14x14x384xf32)
        t35 = paddle._C_ops.transpose(t34, [0, 3, 1, 2])
        del t34
        
        # pd_op.full: (xf32) <- ()
        t36 = paddle._C_ops.full([], float('0'), paddle.float32, paddle.framework._current_expected_place())
        
        return t18, t19, t20, t21, t22, t23, t25, t26, t27, t28, t29, t30, t31, t32, t33, t35, t36
    ...
    def get_input_spec(self):
        return [
            ...
            # t2
            paddle.static.InputSpec(shape=[64, 384, 14, 14], dtype='float32'),
            # t3
            paddle.static.InputSpec(shape=[64, 384, 14, 14], dtype='float32'),
            # t4
            paddle.static.InputSpec(shape=[384, 1, 7, 7], dtype='float32'),
            # t5
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.to_tensor([64, 1, 1, 1], dtype='int64').reshape([4]),
            # t1
            paddle.to_tensor(0.9485710263252258, dtype='float32').reshape([]),
            # t2
            paddle.uniform([64, 384, 14, 14], dtype='float32', min=0, max=0.5),
            # t3
            paddle.uniform([64, 384, 14, 14], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([384, 1, 7, 7], dtype='float32', min=0, max=0.5),
            # t5
