...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6):
        ...
        return t11, t12, t13, t14, t15, t16, t18, t19, t20, t21
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t1
            paddle.to_tensor(0.949999988079071, dtype='float32').reshape([]),
            # t2
            paddle.uniform([124, 768, 7, 7], dtype='float32', min=0, max=0.5),
            # t3
            paddle.uniform([124, 768, 7, 7], dtype='float32', min=0, max=0.5),
            # t4
