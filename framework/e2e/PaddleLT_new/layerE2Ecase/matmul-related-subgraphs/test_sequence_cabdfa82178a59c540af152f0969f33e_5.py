...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11):
        ...
        t7 = paddle._C_ops.full_int_array([-1, 2, 2, 7, 7, 768], paddle.int64, paddle.core.CPUPlace())
        t8 = paddle._C_ops.full_int_array([-1, 14, 14, 768], paddle.int64, paddle.core.CPUPlace())
        t9 = paddle._C_ops.full_int_array([3, 3], paddle.int64, paddle.core.CPUPlace())
        # pd_op.transpose: (-1x49x24x32xf32) <- (-1x24x49x32xf32)
        t12 = paddle._C_ops.transpose(t0, [0, 2, 1, 3])
        del t0
        ...
        t15 = paddle._C_ops.reshape(t12, t14)
        del t14
        ...
        return t12, t15, t16, t17, t18, t20, t21, t22, t25
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([16, 24, 49, 32], dtype='float32', min=0, max=0.5),
            # t1
            ...
            # t7
            paddle.to_tensor([-1, 2, 2, 7, 7, 768], dtype='int64').reshape([6]),
            # t8
            paddle.to_tensor([-1, 14, 14, 768], dtype='int64').reshape([4]),
            # t9
