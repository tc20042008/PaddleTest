...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15):
        ...
        t13 = paddle._C_ops.full_int_array([-1, 7, 7, 384], paddle.int64, paddle.core.CPUPlace())
        t14 = paddle._C_ops.full_int_array([-1, 2, 2, 7, 7, 384], paddle.int64, paddle.core.CPUPlace())
        t15 = paddle._C_ops.full_int_array([-1, 14, 14, 384], paddle.int64, paddle.core.CPUPlace())
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t4
            paddle.uniform([240, 12, 49, 49], dtype='float32', min=0, max=0.5),
            # t5
            ...
            # t8
            paddle.to_tensor(240, dtype='int64').reshape([]),
            # t9
            paddle.uniform([240, 12, 49, 32], dtype='float32', min=0, max=0.5),
            # t10
