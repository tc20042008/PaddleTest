...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t11
            paddle.to_tensor([0.4901893138885498, 0.017027296125888824, 0.46678420901298523], dtype='float32').reshape([3]),
            # t12
            paddle.uniform([1024, 4], dtype='float32', min=0, max=0.5),
            # t13
            paddle.to_tensor([0.43025320768356323, 0.3942321240901947, 0.3175346851348877, 0.39807596802711487], dtype='float32').reshape([4]),
        ]
