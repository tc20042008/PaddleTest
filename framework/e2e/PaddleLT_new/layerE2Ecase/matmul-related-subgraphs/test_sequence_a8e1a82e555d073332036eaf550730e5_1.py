...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10):
        ...
        return t13, t14, t16, t17, t18, t19, t20, t21, t22, t23, t25, t26, t27, t29, t30

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[4, 40, 8, 32], dtype='float32'),
            # t1
            ...
            # t4
            paddle.static.InputSpec(shape=[4, 40, 256], dtype='float32'),
            # t5
            paddle.static.InputSpec(shape=[256], dtype='float32'),
            # t6
            paddle.static.InputSpec(shape=[256], dtype='float32'),
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([4, 40, 8, 32], dtype='float32', min=0, max=0.5),
            # t1
            ...
            # t4
            paddle.uniform([4, 40, 256], dtype='float32', min=0, max=0.5),
            # t5
            paddle.uniform([256], dtype='float32', min=0, max=0.5),
            # t6
            paddle.uniform([256], dtype='float32', min=0, max=0.5),
