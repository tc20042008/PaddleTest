...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.to_tensor([[-6.101469993591309, -0.806725025177002], [15.29800033569336, 2.2189600467681885], [-0.26463499665260315, -0.12540900707244873]], dtype='float32').reshape([3, 2]),
            # t1
