...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t11
            paddle.to_tensor([0.055745676159858704, 0.20114752650260925, 0.017422325909137726], dtype='float32').reshape([3]),
            # t12
            paddle.uniform([1024, 4], dtype='float32', min=0, max=0.5),
            # t13
            paddle.to_tensor([0.13058602809906006, 0.11422126740217209, 0.009717742912471294, 0.35330426692962646], dtype='float32').reshape([4]),
        ]
