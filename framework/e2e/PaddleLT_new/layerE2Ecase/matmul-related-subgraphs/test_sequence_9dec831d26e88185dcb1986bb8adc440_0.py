...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16):
        ...
        t12 = paddle._C_ops.full_int_array([64, 28, 28, 192], paddle.int64, paddle.core.CPUPlace())
        t13 = paddle._C_ops.full_int_array([-3, -3], paddle.int64, paddle.core.CPUPlace())
        t14 = paddle._C_ops.full_int_array([64, 4, 7, 4, 7, 192], paddle.int64, paddle.core.CPUPlace())
        t15 = paddle._C_ops.full_int_array([-1, 7, 7, 192], paddle.int64, paddle.core.CPUPlace())
        t16 = paddle._C_ops.full_int_array([-1, 49, 192], paddle.int64, paddle.core.CPUPlace())
        t17 = 0.0
        t18 = 1.0
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t14
            paddle.to_tensor([64, 4, 7, 4, 7, 192], dtype='int64').reshape([6]),
            # t15
            paddle.to_tensor([-1, 7, 7, 192], dtype='int64').reshape([4]),
            # t16
            paddle.to_tensor([-1, 49, 192], dtype='int64').reshape([3]),
        ]
