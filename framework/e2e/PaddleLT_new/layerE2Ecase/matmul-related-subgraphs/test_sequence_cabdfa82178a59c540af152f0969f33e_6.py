...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9):
        t6 = paddle._C_ops.full_int_array([-1, 7, 7, 1536], paddle.int64, paddle.core.CPUPlace())
        t7 = paddle._C_ops.full_int_array([-1, 1, 1, 7, 7, 1536], paddle.int64, paddle.core.CPUPlace())
        t8 = paddle._C_ops.full_int_array([3, 3], paddle.int64, paddle.core.CPUPlace())
        # pd_op.transpose: (-1x49x48x32xf32) <- (-1x48x49x32xf32)
        t10 = paddle._C_ops.transpose(t0, [0, 2, 1, 3])
        del t0
        ...
        t12 = paddle._C_ops.stack(t11, 0)
        del t11
        
        # pd_op.reshape: (-1x49x1536xf32) <- (-1x49x48x32xf32, 3xi64)
        t13 = paddle._C_ops.reshape(t10, t12)
        del t12
        ...
        return t10, t13, t14, t15, t16, t18, t19, t20, t23

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[None, 48, 49, 32], dtype='float32'),
            # t1
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t4
            paddle.static.InputSpec(shape=[1536, 1536], dtype='float32'),
            # t5
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([4, 48, 49, 32], dtype='float32', min=0, max=0.5),
            # t1
            ...
            # t4
            paddle.uniform([1536, 1536], dtype='float32', min=0, max=0.5),
            # t5
            paddle.uniform([1536], dtype='float32', min=0, max=0.5),
            # t6
            paddle.to_tensor([-1, 7, 7, 1536], dtype='int64').reshape([4]),
            # t7
            paddle.to_tensor([-1, 1, 1, 7, 7, 1536], dtype='int64').reshape([6]),
            # t8
