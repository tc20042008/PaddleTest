...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[768], dtype='float32'),
            # t3
            paddle.static.InputSpec(shape=[768, 512], dtype='float32'),
        ]
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([32, 196, 768], dtype='float32', min=0, max=0.5),
            # t1
            paddle.uniform([768], dtype='float32', min=0, max=0.5),
            # t2
            paddle.uniform([768], dtype='float32', min=0, max=0.5),
            # t3
            paddle.uniform([768, 512], dtype='float32', min=0, max=0.5),
        ]
