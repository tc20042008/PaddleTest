...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, ):
        ...
        # pd_op.full: (1xf64) <- ()
        t8 = paddle._C_ops.full([1], float('128'), paddle.float64, paddle.core.CPUPlace())
        ...
        # pd_op.full: (1xf32) <- ()
        t10 = paddle._C_ops.full([1], float('0.0078125'), paddle.float32, paddle.core.CPUPlace())
        ...
        # pd_op.full: (128xf32) <- ()
        t12 = paddle._C_ops.full([128], float('10000'), paddle.float32, paddle.framework._current_expected_place())
        ...
        # pd_op.full: (128xf32) <- ()
        t14 = paddle._C_ops.full([128], float('1'), paddle.float32, paddle.framework._current_expected_place())
        ...
        # pd_op.matmul: (484x128xf32) <- (484x1xf32, 1x128xf32)
        ...
        # pd_op.sin: (484x128xf32) <- (484x128xf32)
        t25 = paddle._C_ops.sin(t21)
        
        # pd_op.cos: (484x128xf32) <- (484x128xf32)
        ...
        # builtin.combine: ([484x128xf32, 484x128xf32, 484x128xf32, 484x128xf32]) <- (484x128xf32, 484x128xf32, 484x128xf32, 484x128xf32)
        t30 = [t25, t26, t27, t28]
        del t26, t28, t25, t27
        
        # pd_op.concat: (484x512xf32) <- ([484x128xf32, 484x128xf32, 484x128xf32, 484x128xf32], 1xi32)
        t31 = paddle._C_ops.concat(t30, t29)
        del t30, t29
        
        # pd_op.unsqueeze: (1x484x512xf32) <- (484x512xf32, 1xi64)
