...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4):
        ...
        t5, t6, t7 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t0, t1, t2, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t2, t1
        
        # pd_op.matmul: (32x197x2304xf32) <- (32x197x768xf32, 768x2304xf32)
        t8 = paddle._C_ops.matmul(t5, t3, False, False)
        del t3
