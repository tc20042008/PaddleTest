...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15):
        ...
        t13 = paddle._C_ops.full_int_array([-1, 7, 7, 96], paddle.int64, paddle.core.CPUPlace())
        t14 = paddle._C_ops.full_int_array([-1, 8, 8, 7, 7, 96], paddle.int64, paddle.core.CPUPlace())
        t15 = paddle._C_ops.full_int_array([-1, 56, 56, 96], paddle.int64, paddle.core.CPUPlace())
        ...
        return t18, t20, t21, t25, t27, t30, t31, t32, t33, t35, t36
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t4
            paddle.static.InputSpec(shape=[None, 3, 49, 49], dtype='float32'),
            # t5
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t4
            paddle.uniform([3840, 3, 49, 49], dtype='float32', min=0, max=0.5),
            # t5
            ...
            # t8
            paddle.to_tensor(3840, dtype='int64').reshape([]),
            # t9
            paddle.uniform([3840, 3, 49, 32], dtype='float32', min=0, max=0.5),
            # t10
