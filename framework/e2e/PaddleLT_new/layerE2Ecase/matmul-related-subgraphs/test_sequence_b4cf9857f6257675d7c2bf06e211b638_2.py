...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        t1 = paddle._C_ops.full_int_array([2, 8400, 8, 32], paddle.int64, paddle.core.CPUPlace())
        # pd_op.reshape: (2x8400x8x32xf32) <- (2x8400x256xf32, 4xi64)
    ...
    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[2, 8400, 256], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([2, 8400, 256], dtype='float32', min=0, max=0.5),
            # t1
            paddle.to_tensor([2, 8400, 8, 32], dtype='int64').reshape([4]),
            # t2
