...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11):
        ...
        t7 = paddle._C_ops.full_int_array([-1, 4, 4, 7, 7, 384], paddle.int64, paddle.core.CPUPlace())
        t8 = paddle._C_ops.full_int_array([-1, 28, 28, 384], paddle.int64, paddle.core.CPUPlace())
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([64, 12, 49, 32], dtype='float32', min=0, max=0.5),
            # t1
            ...
            # t7
            paddle.to_tensor([-1, 4, 4, 7, 7, 384], dtype='int64').reshape([6]),
            # t8
            paddle.to_tensor([-1, 28, 28, 384], dtype='int64').reshape([4]),
            # t9
