...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20):
        ...
        t20 = paddle._C_ops.full_int_array([-1, 144, 768], paddle.int64, paddle.core.CPUPlace())
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t3
            paddle.static.InputSpec(shape=[None, 24, 24, 768], dtype='float32'),
            # t4
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t1
            paddle.to_tensor(576, dtype='int64').reshape([]),
            # t2
            paddle.to_tensor(768, dtype='int64').reshape([]),
            # t3
            paddle.uniform([32, 24, 24, 768], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([32, 576, 768], dtype='float32', min=0, max=0.5),
            # t5
