...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3):
        t1 = paddle._C_ops.full_int_array([-1, 49, 768], paddle.int64, paddle.core.CPUPlace())
    ...
    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[64, 7, 7, 768], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([64, 7, 7, 768], dtype='float32', min=0, max=0.5),
            # t1
