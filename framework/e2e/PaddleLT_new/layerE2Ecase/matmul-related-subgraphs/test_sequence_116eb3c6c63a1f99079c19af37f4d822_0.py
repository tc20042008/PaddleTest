...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9):
        ...
        t14 = paddle._C_ops.reshape(t11, t13)
        del t13
        
        # pd_op.transpose: (4x12x-1x32xf32) <- (4x-1x12x32xf32)
        t15 = paddle._C_ops.transpose(t14, [0, 2, 1, 3])
        del t14
        
        # pd_op.matmul: (4x40x768xf32) <- (4x40x384xf32, 384x768xf32)
        t16 = paddle._C_ops.matmul(t7, t8, False, False)
        del t8
        
        # pd_op.add: (4x40x768xf32) <- (4x40x768xf32, 768xf32)
        t17 = paddle._C_ops.add(t16, t9)
        del t9
        
        # pd_op.full_int_array: (5xi64) <- ()
        t18 = [0, 40, 2, 12, 32]
        
        return t10, t11, t15, t16, t17, t18
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t7
            paddle.static.InputSpec(shape=[4, 40, 384], dtype='float32'),
            # t8
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t7
            paddle.uniform([4, 40, 384], dtype='float32', min=0, max=0.5),
            # t8
