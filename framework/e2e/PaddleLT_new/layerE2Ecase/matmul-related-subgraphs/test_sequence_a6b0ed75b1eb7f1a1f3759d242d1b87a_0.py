...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t3
            paddle.static.InputSpec(shape=[None, 96, 96, 192], dtype='float32'),
            # t4
            paddle.static.InputSpec(shape=[None, 9216, 192], dtype='float32'),
            # t5
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t1
            paddle.to_tensor(9216, dtype='int64').reshape([]),
            # t2
            paddle.to_tensor(192, dtype='int64').reshape([]),
            # t3
            paddle.uniform([32, 96, 96, 192], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([32, 9216, 192], dtype='float32', min=0, max=0.5),
            # t5
