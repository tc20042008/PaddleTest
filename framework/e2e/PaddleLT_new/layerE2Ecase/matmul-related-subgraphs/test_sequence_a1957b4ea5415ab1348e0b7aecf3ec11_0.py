...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9):
        ...
        t13 = paddle._C_ops.uniform(t1, paddle.float32, t10, t11, 0, paddle.framework._current_expected_place())
        
        # pd_op.add: (64x1x1xf32) <- (xf32, 64x1x1xf32)
        t14 = paddle._C_ops.add(t0, t13)
        del t13
        
        # pd_op.floor: (64x1x1xf32) <- (64x1x1xf32)
        t15 = paddle._C_ops.floor(t14)
        del t14
        
        # pd_op.divide: (64x49x768xf32) <- (64x49x768xf32, xf32)
        t16 = paddle._C_ops.divide(t2, t0)
        
        # pd_op.multiply: (64x49x768xf32) <- (64x49x768xf32, 64x1x1xf32)
        t17 = paddle._C_ops.multiply(t16, t15)
        
        # pd_op.add: (64x49x768xf32) <- (64x49x768xf32, 64x49x768xf32)
        t18 = paddle._C_ops.add(t3, t17)
        
        # pd_op.layer_norm: (64x49x768xf32, 64x49xf32, 64x49xf32) <- (64x49x768xf32, 768xf32, 768xf32)
        t19, t20, t21 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t18, t4, t5, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t5, t4
        
        # pd_op.matmul: (64x49x3072xf32) <- (64x49x768xf32, 768x3072xf32)
        t22 = paddle._C_ops.matmul(t19, t6, False, False)
        del t6
        ...
        t24 = paddle._C_ops.gelu(t23, False)
        ...
        # pd_op.uniform: (64x1x1xf32) <- (3xi64, 1xf32, 1xf32)
        t27 = paddle._C_ops.uniform(t1, paddle.float32, t10, t11, 0, paddle.framework._current_expected_place())
        del t10, t11, t1
        
        # pd_op.add: (64x1x1xf32) <- (xf32, 64x1x1xf32)
        t28 = paddle._C_ops.add(t0, t27)
        del t27
        
        # pd_op.floor: (64x1x1xf32) <- (64x1x1xf32)
        t29 = paddle._C_ops.floor(t28)
        del t28
        
        # pd_op.divide: (64x49x768xf32) <- (64x49x768xf32, xf32)
        t30 = paddle._C_ops.divide(t26, t0)
        
        # pd_op.multiply: (64x49x768xf32) <- (64x49x768xf32, 64x1x1xf32)
        t31 = paddle._C_ops.multiply(t30, t29)
        
        # pd_op.add: (64x49x768xf32) <- (64x49x768xf32, 64x49x768xf32)
        t32 = paddle._C_ops.add(t18, t31)
        
        return t12, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t29, t30, t31, t32
