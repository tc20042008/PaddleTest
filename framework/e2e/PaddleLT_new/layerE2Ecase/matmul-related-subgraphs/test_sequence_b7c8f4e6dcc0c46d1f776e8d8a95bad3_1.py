...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14):
        ...
        # pd_op.roi_align: (-1x256x7x7xf32) <- (2x256x-1x-1xf32, -1x4xf32, -1xi32)
    ...
    def get_input_spec(self):
        return [
            ...
            # t3
            paddle.static.InputSpec(shape=[2, 256, None, None], dtype='float32'),
            # t4
            paddle.static.InputSpec(shape=[2, 256, None, None], dtype='float32'),
            # t5
            paddle.static.InputSpec(shape=[2, 256, None, None], dtype='float32'),
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t3
            paddle.uniform([2, 256, 224, 168], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([2, 256, 112, 84], dtype='float32', min=0, max=0.5),
            # t5
            paddle.uniform([2, 256, 56, 42], dtype='float32', min=0, max=0.5),
            # t6
            paddle.uniform([2, 256, 28, 21], dtype='float32', min=0, max=0.5),
            # t7
            ...
            # t12
            paddle.to_tensor([0.329087495803833, 0.16775070130825043, 0.2763849198818207, 0.4152645170688629, 0.4969750642776489], dtype='float32').reshape([5]),
            # t13
            paddle.uniform([1024, 16], dtype='float32', min=0, max=0.5),
            # t14
            paddle.to_tensor([0.4967247247695923, 0.08293528854846954, 0.30142802000045776, 0.3454573452472687, 0.07449264824390411, 0.4133836328983307, 0.3631102442741394, 0.00861529354006052, 0.03616735711693764, 0.04429633170366287, 0.011391717940568924, 0.029249774292111397, 0.23842114210128784, 0.16083505749702454, 0.33097997307777405, 0.3187362849712372], dtype='float32').reshape([16]),
        ]
