...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        t3 = paddle._C_ops.full_int_array([-1, 197, 3, 12, 64], paddle.int64, paddle.core.CPUPlace())
        ...
        t13 = paddle._C_ops.slice(t12, [0], t4, t5, [1], [0])
        
        # pd_op.slice: (32x12x197x64xf32) <- (3x32x12x197x64xf32, 1xi64, 1xi64)
        t14 = paddle._C_ops.slice(t12, [0], t5, t6, [1], [0])
        
        # pd_op.slice: (32x12x197x64xf32) <- (3x32x12x197x64xf32, 1xi64, 1xi64)
        t15 = paddle._C_ops.slice(t12, [0], t6, t7, [1], [0])
        
        # pd_op.transpose: (32x12x64x197xf32) <- (32x12x197x64xf32)
        t16 = paddle._C_ops.transpose(t14, [0, 1, 3, 2])
        del t14
        
        # pd_op.matmul: (32x12x197x197xf32) <- (32x12x197x64xf32, 32x12x64x197xf32)
        t17 = paddle._C_ops.matmul(t13, t16, False, False)
        
        # pd_op.scale: (32x12x197x197xf32) <- (32x12x197x197xf32, 1xf32)
        t18 = paddle._C_ops.scale(t17, t8, float('0'), True)
        del t17
        ...
        t20 = paddle._C_ops.matmul(t19, t15, False, False)
        
        # pd_op.transpose: (32x197x12x64xf32) <- (32x12x197x64xf32)
        t21 = paddle._C_ops.transpose(t20, [0, 2, 1, 3])
        del t20
        
        return t9, t10, t12, t13, t15, t16, t19, t21

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[32, 197, 768], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([32, 197, 768], dtype='float32', min=0, max=0.5),
            # t1
