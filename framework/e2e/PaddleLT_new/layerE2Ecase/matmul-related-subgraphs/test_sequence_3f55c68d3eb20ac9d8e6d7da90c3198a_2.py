...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[1], dtype='int64'),
            # t16
            paddle.static.InputSpec(shape=[169, 24], dtype='float32'),
            # t17
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            paddle.uniform([1, 49, 49], dtype='float32', min=0, max=0.5),
            # t3
            paddle.uniform([60, 49, 768], dtype='float32', min=0, max=0.5),
            # t4
            ...
            paddle.to_tensor([-1], dtype='int64').reshape([1]),
            # t16
            paddle.uniform([169, 24], dtype='float32', min=0, max=0.5),
            # t17
