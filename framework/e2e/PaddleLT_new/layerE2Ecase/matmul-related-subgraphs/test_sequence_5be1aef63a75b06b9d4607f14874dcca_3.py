...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t11
            paddle.to_tensor([0.33387258648872375, 0.3796837627887726, 0.4449242353439331], dtype='float32').reshape([3]),
            # t12
            paddle.uniform([1024, 4], dtype='float32', min=0, max=0.5),
            # t13
            paddle.to_tensor([0.12560178339481354, 0.4825783669948578, 0.18702934682369232, 0.303301602602005], dtype='float32').reshape([4]),
        ]
