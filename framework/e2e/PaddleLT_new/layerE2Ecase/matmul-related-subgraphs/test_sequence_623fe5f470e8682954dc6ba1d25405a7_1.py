...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9):
        ...
        t10 = paddle._C_ops.reshape(t0, t1)
        del t0
        
        # pd_op.add: (32x384x14x14xf32) <- (32x384x14x14xf32, 1x384x1x1xf32)
        t11 = paddle._C_ops.add(t2, t10)
        
        # pd_op.transpose: (32x14x14x384xf32) <- (32x384x14x14xf32)
        t12 = paddle._C_ops.transpose(t11, [0, 2, 3, 1])
        del t11
        
        # pd_op.layer_norm: (32x14x14x384xf32, 32x14x14xf32, 32x14x14xf32) <- (32x14x14x384xf32, 384xf32, 384xf32)
        t13, t14, t15 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t12, t3, t4, float('1e-06'), 3), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t4, t3
        ...
        t21 = paddle._C_ops.multiply(t9, t20)
        del t9
        
        # pd_op.transpose: (32x384x14x14xf32) <- (32x14x14x384xf32)
        t22 = paddle._C_ops.transpose(t21, [0, 3, 1, 2])
        del t21
        
        # pd_op.full: (xf32) <- ()
        t23 = paddle._C_ops.full([], float('0'), paddle.float32, paddle.framework._current_expected_place())
        
        return t10, t12, t13, t14, t15, t16, t17, t18, t19, t20, t22, t23
