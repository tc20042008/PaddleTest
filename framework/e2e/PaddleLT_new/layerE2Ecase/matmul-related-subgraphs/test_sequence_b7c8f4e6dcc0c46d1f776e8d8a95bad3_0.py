...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t3
            paddle.uniform([2, 256, 208, 256], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([2, 256, 104, 128], dtype='float32', min=0, max=0.5),
            # t5
            paddle.uniform([2, 256, 52, 64], dtype='float32', min=0, max=0.5),
            # t6
            paddle.uniform([2, 256, 26, 32], dtype='float32', min=0, max=0.5),
            # t7
            ...
            # t12
            paddle.to_tensor([0.40864652395248413, 0.46313026547431946, 0.2176554948091507, 0.3754393756389618, 0.37625905871391296], dtype='float32').reshape([5]),
            # t13
            paddle.uniform([1024, 16], dtype='float32', min=0, max=0.5),
            # t14
            paddle.to_tensor([0.06616227328777313, 0.2248547375202179, 0.43226754665374756, 0.31997767090797424, 0.40260347723960876, 0.04681782424449921, 0.3500930964946747, 0.4127715826034546, 0.17988303303718567, 0.12921446561813354, 0.4141128659248352, 0.11085331439971924, 0.19042149186134338, 0.3951428234577179, 0.2078205943107605, 0.2134583443403244], dtype='float32').reshape([16]),
        ]
