...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.to_tensor([[-2.6825499534606934, 0.24669499695301056], [7.542669773101807, 0.2239769995212555], [-0.008741330355405807, 0.48757898807525635]], dtype='float32').reshape([3, 2]),
            # t1
