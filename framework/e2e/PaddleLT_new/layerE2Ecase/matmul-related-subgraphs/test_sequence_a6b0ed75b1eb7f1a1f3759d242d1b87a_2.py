...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12):
        ...
        t15 = paddle._C_ops.reshape(t3, t14)
        del t3, t14
        ...
        t17, t18, t19 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t16, t5, t6, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t6, t5
        ...
        t27 = paddle._C_ops.slice(t26, [0], t11, t12, [1], [0])
        del t26
    ...
    def get_input_spec(self):
        return [
            ...
            # t4
            paddle.static.InputSpec(shape=[None, 2304, 384], dtype='float32'),
            # t5
