...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12):
        ...
        t16 = paddle._C_ops.uniform(t1, paddle.float32, t13, t14, 0, paddle.framework._current_expected_place())
        
        # pd_op.add: (64x1x1xf32) <- (xf32, 64x1x1xf32)
        t17 = paddle._C_ops.add(t0, t16)
        del t16
        ...
        t19 = paddle._C_ops.divide(t2, t0)
        ...
        t22, t23, t24 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t21, t4, t5, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t5, t4
        
        # pd_op.matmul: (64x196x1536xf32) <- (64x196x384xf32, 384x1536xf32)
        t25 = paddle._C_ops.matmul(t22, t6, False, False)
        del t6
        ...
        t27 = paddle._C_ops.gelu(t26, False)
        
        # pd_op.matmul: (64x196x384xf32) <- (64x196x1536xf32, 1536x384xf32)
        t28 = paddle._C_ops.matmul(t27, t8, False, False)
        del t8
        ...
        # pd_op.uniform: (64x1x1xf32) <- (3xi64, 1xf32, 1xf32)
        t30 = paddle._C_ops.uniform(t1, paddle.float32, t13, t14, 0, paddle.framework._current_expected_place())
        
        # pd_op.add: (64x1x1xf32) <- (xf32, 64x1x1xf32)
        t31 = paddle._C_ops.add(t0, t30)
        del t30
        
        # pd_op.floor: (64x1x1xf32) <- (64x1x1xf32)
        t32 = paddle._C_ops.floor(t31)
        del t31
        
        # pd_op.divide: (64x196x384xf32) <- (64x196x384xf32, xf32)
        t33 = paddle._C_ops.divide(t29, t0)
        
        # pd_op.multiply: (64x196x384xf32) <- (64x196x384xf32, 64x1x1xf32)
        t34 = paddle._C_ops.multiply(t33, t32)
        
        # pd_op.add: (64x196x384xf32) <- (64x196x384xf32, 64x196x384xf32)
        t35 = paddle._C_ops.add(t21, t34)
        
        # pd_op.layer_norm: (64x196x384xf32, 64x196xf32, 64x196xf32) <- (64x196x384xf32, 384xf32, 384xf32)
        t36, t37, t38 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t35, t10, t11, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t11, t10
        
        # pd_op.reshape: (64x14x14x384xf32) <- (64x196x384xf32, 4xi64)
        t39 = paddle._C_ops.reshape(t36, t12)
        
        return t15, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t32, t33, t34, t35, t36, t37, t38, t39
