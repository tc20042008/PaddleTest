...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def get_input_spec(self):
        return [
            ...
            # t2
            paddle.static.InputSpec(shape=[120, 120], dtype='float32'),
            # t3
            ...
            paddle.static.InputSpec(shape=[120], dtype='float32'),
            # t7
            paddle.static.InputSpec(shape=[120, 240], dtype='float32'),
            # t8
            paddle.static.InputSpec(shape=[240], dtype='float32'),
            # t9
            paddle.static.InputSpec(shape=[240, 120], dtype='float32'),
            # t10
            paddle.static.InputSpec(shape=[120], dtype='float32'),
        ]
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t2
            paddle.uniform([120, 120], dtype='float32', min=0, max=0.5),
            # t3
            ...
            paddle.uniform([120], dtype='float32', min=0, max=0.5),
            # t7
            paddle.uniform([120, 240], dtype='float32', min=0, max=0.5),
            # t8
            paddle.uniform([240], dtype='float32', min=0, max=0.5),
            # t9
            paddle.uniform([240, 120], dtype='float32', min=0, max=0.5),
            # t10
            paddle.uniform([120], dtype='float32', min=0, max=0.5),
        ]
