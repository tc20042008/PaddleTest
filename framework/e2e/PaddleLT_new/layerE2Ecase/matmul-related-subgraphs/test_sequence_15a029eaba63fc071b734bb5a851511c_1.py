...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4):
        ...
        # pd_op.full: (1xi32) <- ()
        t7 = paddle._C_ops.full([1], float('2'), paddle.int32, paddle.core.CPUPlace())
        
        # pd_op.split_with_num: ([20x-1x1024xf32, 20x-1x1024xf32]) <- (20x-1x2048xf32, 1xi32)
        t8 = paddle._C_ops.split_with_num(t6, 2, t7)
        del t6
        ...
        t11 = paddle._C_ops.gelu(t10, False)
        
        # pd_op.multiply: (20x-1x1024xf32) <- (20x-1x1024xf32, 20x-1x1024xf32)
        t12 = paddle._C_ops.multiply(t9, t11)
        ...
        return t5, t7, t9, t10, t11, t12, t13, t14
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([20, 175, 256], dtype='float32', min=0, max=0.5),
            # t1
