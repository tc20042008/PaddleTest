...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        t1 = paddle._C_ops.full_int_array([-1, 63, 12, 49, 49], paddle.int64, paddle.core.CPUPlace())
        ...
        t15 = paddle._C_ops.matmul(t14, t5, False, False)
        
        # pd_op.transpose: (126x49x12x32xf32) <- (126x12x49x32xf32)
        t16 = paddle._C_ops.transpose(t15, [0, 2, 1, 3])
        del t15
        ...
        t19 = paddle._C_ops.matmul(t18, t6, False, False)
        del t6
        ...
        return t8, t10, t11, t14, t16, t18, t19, t20

    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[126, 12, 49, 49], dtype='float32'),
            # t1
            paddle.static.InputSpec(shape=[5], dtype='int64'),
            # t2
            paddle.static.InputSpec(shape=[63, 49, 49], dtype='float32'),
            # t3
            paddle.static.InputSpec(shape=[1], dtype='int64'),
            # t4
            paddle.static.InputSpec(shape=[1], dtype='int64'),
            # t5
            paddle.static.InputSpec(shape=[126, 12, 49, 32], dtype='float32'),
            # t6
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([126, 12, 49, 49], dtype='float32', min=0, max=0.5),
            # t1
            paddle.to_tensor([-1, 63, 12, 49, 49], dtype='int64').reshape([5]),
            # t2
            paddle.uniform([63, 49, 49], dtype='float32', min=0, max=0.5),
            # t3
            paddle.to_tensor([1], dtype='int64').reshape([1]),
            # t4
            paddle.to_tensor([0], dtype='int64').reshape([1]),
            # t5
            paddle.uniform([126, 12, 49, 32], dtype='float32', min=0, max=0.5),
            # t6
