...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9):
        t1 = paddle._C_ops.full_int_array([8192, 49, 3, 3, 32], paddle.int64, paddle.core.CPUPlace())
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([8192, 49, 288], dtype='float32', min=0, max=0.5),
            # t1
            paddle.to_tensor([8192, 49, 3, 3, 32], dtype='int64').reshape([5]),
            # t2
