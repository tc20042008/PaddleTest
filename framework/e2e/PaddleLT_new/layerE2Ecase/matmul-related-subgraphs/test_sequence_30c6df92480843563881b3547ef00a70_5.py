...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, ):
        ...
        # pd_op.full: (1xf64) <- ()
        t1 = paddle._C_ops.full([1], float('25'), paddle.float64, paddle.core.CPUPlace())
        ...
        # pd_op.meshgrid: ([25x25xf32, 25x25xf32]) <- ([25xf32, 25xf32])
        t5 = paddle._C_ops.meshgrid(t4)
        del t4
        
        # builtin.split: (25x25xf32, 25x25xf32) <- ([25x25xf32, 25x25xf32])
        t6, t7, = t5
        del t5
        ...
        # pd_op.flatten: (625xf32) <- (25x25xf32)
        ...
        # pd_op.unsqueeze: (625x1xf32) <- (625xf32, 1xi64)
        ...
        # pd_op.matmul: (625x96xf32) <- (625x1xf32, 1x96xf32)
        ...
        # pd_op.sin: (625x96xf32) <- (625x96xf32)
        t25 = paddle._C_ops.sin(t21)
        
        # pd_op.cos: (625x96xf32) <- (625x96xf32)
        ...
        # builtin.combine: ([625x96xf32, 625x96xf32, 625x96xf32, 625x96xf32]) <- (625x96xf32, 625x96xf32, 625x96xf32, 625x96xf32)
        t30 = [t25, t26, t27, t28]
        del t26, t28, t25, t27
        
        # pd_op.concat: (625x384xf32) <- ([625x96xf32, 625x96xf32, 625x96xf32, 625x96xf32], 1xi32)
        t31 = paddle._C_ops.concat(t30, t29)
        del t30, t29
        
        # pd_op.unsqueeze: (1x625x384xf32) <- (625x384xf32, 1xi64)
