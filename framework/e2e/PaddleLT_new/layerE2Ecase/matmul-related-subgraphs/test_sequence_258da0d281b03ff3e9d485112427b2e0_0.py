...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12):
        ...
        t16 = paddle._C_ops.add(t4, t15)
        del t15, t4
        
        # pd_op.layer_norm: (-1x-1x384xf32, -1x-1xf32, -1x-1xf32) <- (-1x-1x384xf32, 384xf32, 384xf32)
        t17, t18, t19 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t16, t5, t6, float('1e-06'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t16, t6, t5
        
        # pd_op.matmul: (-1x-1x1536xf32) <- (-1x-1x384xf32, 384x1536xf32)
        t20 = paddle._C_ops.matmul(t17, t7, False, False)
        del t7
        ...
        # pd_op.layer_norm: (-1x-1x384xf32, -1x-1xf32, -1x-1xf32) <- (-1x-1x384xf32, 384xf32, 384xf32)
        t26, t27, t28 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t25, t11, t12, float('1e-06'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t25, t12, t11
