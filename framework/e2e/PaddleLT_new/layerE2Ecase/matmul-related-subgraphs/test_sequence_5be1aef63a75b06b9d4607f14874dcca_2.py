...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t11
            paddle.to_tensor([0.3553699851036072, 0.32602861523628235, 0.3281252682209015], dtype='float32').reshape([3]),
            # t12
            paddle.uniform([1024, 4], dtype='float32', min=0, max=0.5),
            # t13
            paddle.to_tensor([0.43174827098846436, 0.11401597410440445, 0.40368205308914185, 0.13161195814609528], dtype='float32').reshape([4]),
        ]
