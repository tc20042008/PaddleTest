...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10):
        ...
        t12 = paddle._C_ops.slice(t11, [0], t1, t2, [1], [0])
        del t11
        
        # pd_op.matmul: (-1x-1x384xf32) <- (-1x-1x384xf32, 384x384xf32)
        t13 = paddle._C_ops.matmul(t0, t3, False, False)
        del t3
        ...
        t17 = paddle._C_ops.reshape(t14, t16)
        del t16
        
        # pd_op.transpose: (-1x12x-1x32xf32) <- (-1x-1x12x32xf32)
        t18 = paddle._C_ops.transpose(t17, [0, 2, 1, 3])
        del t17
        
        # pd_op.matmul: (-1x40x768xf32) <- (-1x40x384xf32, 384x768xf32)
        t19 = paddle._C_ops.matmul(t8, t9, False, False)
        del t9
        
        # pd_op.add: (-1x40x768xf32) <- (-1x40x768xf32, 768xf32)
        t20 = paddle._C_ops.add(t19, t10)
        del t10
        
        return t12, t13, t14, t18, t19, t20
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t8
            paddle.static.InputSpec(shape=[None, 40, 384], dtype='float32'),
            # t9
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t8
            paddle.uniform([5, 40, 384], dtype='float32', min=0, max=0.5),
            # t9
