...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        ...
        t8 = paddle._C_ops.slice(t0, [0], t1, t2, [1], [0])
        del t0
        
        # pd_op.flatten: (-1x120x40xf32) <- (-1x120x1x40xf32)
        t9 = paddle._C_ops.flatten(t3, 2, 3)
        ...
        t11, t12, t13 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t10, t4, t5, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t5, t4
        
        # pd_op.matmul: (-1x40x360xf32) <- (-1x40x120xf32, 120x360xf32)
        t14 = paddle._C_ops.matmul(t11, t6, False, False)
        del t6
        
        # pd_op.add: (-1x40x360xf32) <- (-1x40x360xf32, 360xf32)
        t15 = paddle._C_ops.add(t14, t7)
        del t7
        ...
        t18 = paddle._C_ops.transpose(t17, [2, 0, 3, 1, 4])
        del t17
        
        return t10, t11, t12, t13, t14, t15, t16, t18
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[1], dtype='int64'),
            # t3
            paddle.static.InputSpec(shape=[None, 120, 1, 40], dtype='float32'),
            # t4
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.to_tensor([5, 120, 1, 40], dtype='int64').reshape([4]),
            # t1
            paddle.to_tensor([0], dtype='int64').reshape([1]),
            # t2
            paddle.to_tensor([1], dtype='int64').reshape([1]),
            # t3
            paddle.uniform([5, 120, 1, 40], dtype='float32', min=0, max=0.5),
            # t4
