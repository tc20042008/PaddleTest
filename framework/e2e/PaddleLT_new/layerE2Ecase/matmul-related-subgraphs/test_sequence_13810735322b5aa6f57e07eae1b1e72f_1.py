...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1):
        # pd_op.full: (1xf32) <- ()
        t2 = paddle._C_ops.full([1], float('0.176777'), paddle.float32, paddle.core.CPUPlace())
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([8, 8, 480, 480], dtype='float32', min=0, max=0.5),
            # t1
            paddle.uniform([8, 8, 480, 32], dtype='float32', min=0, max=0.5),
        ]
