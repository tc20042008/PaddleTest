...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3):
        t1 = paddle._C_ops.full_int_array([-1, 49, 192], paddle.int64, paddle.core.CPUPlace())
        ...
        t5 = paddle._C_ops.matmul(t4, t2, False, False)
        del t2
        
        # pd_op.add: (1024x49x576xf32) <- (1024x49x576xf32, 576xf32)
        t6 = paddle._C_ops.add(t5, t3)
        del t3
    ...
    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[1024, 7, 7, 192], dtype='float32'),
            # t1
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([1024, 7, 7, 192], dtype='float32', min=0, max=0.5),
            # t1
