...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11):
        ...
        t12 = paddle._C_ops.shape64(t0)
        
        # pd_op.slice: (xi64) <- (3xi64, 1xi64, 1xi64)
        t13 = paddle._C_ops.slice(t12, [0], t1, t2, [1], [0])
        del t12
        
        # pd_op.matmul: (-1x-1x384xf32) <- (-1x-1x384xf32, 384x384xf32)
        t14 = paddle._C_ops.matmul(t3, t4, False, False)
        del t4
        ...
        t20 = paddle._C_ops.matmul(t0, t10, False, False)
        del t10
        
        # pd_op.add: (-1x40x768xf32) <- (-1x40x768xf32, 768xf32)
        t21 = paddle._C_ops.add(t20, t11)
        del t11
        
        return t14, t15, t19, t20, t21
