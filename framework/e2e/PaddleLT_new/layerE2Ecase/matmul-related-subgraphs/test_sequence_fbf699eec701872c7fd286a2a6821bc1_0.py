...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6):
        ...
        t7, t8, t9 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t0, t1, t2, float('1e-06'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t2, t1, t0
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([8, 960, 128], dtype='float32', min=0, max=0.5),
            # t1
