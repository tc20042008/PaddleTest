...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15):
        ...
        t10 = paddle._C_ops.full_int_array([-1, 7, 7, 512], paddle.int64, paddle.core.CPUPlace())
        t11 = paddle._C_ops.full_int_array([-1, 2, 2, 7, 7, 512], paddle.int64, paddle.core.CPUPlace())
        t12 = paddle._C_ops.full_int_array([-1, 14, 14, 512], paddle.int64, paddle.core.CPUPlace())
        ...
        # pd_op.add: (-1x4x16x49x49xf32) <- (-1x4x16x49x49xf32, 1x4x1x49x49xf32)
        ...
        # pd_op.reshape: (-1x16x49x49xf32) <- (-1x4x16x49x49xf32, 4xi64)
        t20 = paddle._C_ops.reshape(t17, t19)
        del t17, t19
        
        # pd_op.softmax: (-1x16x49x49xf32) <- (-1x16x49x49xf32)
        t21 = paddle._C_ops.softmax(t20, -1)
        del t20
        
        # pd_op.matmul: (-1x16x49x32xf32) <- (-1x16x49x49xf32, -1x16x49x32xf32)
        t22 = paddle._C_ops.matmul(t21, t6, False, False)
        del t6, t21
        
        # pd_op.transpose: (-1x49x16x32xf32) <- (-1x16x49x32xf32)
        ...
        # pd_op.reshape: (-1x49x512xf32) <- (-1x49x16x32xf32, 3xi64)
        ...
        # pd_op.add: (-1x49x512xf32) <- (-1x49x512xf32, 512xf32)
        t28 = paddle._C_ops.add(t27, t9)
        del t27, t9
        
        # pd_op.reshape: (-1x7x7x512xf32) <- (-1x49x512xf32, 4xi64)
        t29 = paddle._C_ops.reshape(t28, t10)
        del t28, t10
        
        # pd_op.reshape: (-1x2x2x7x7x512xf32) <- (-1x7x7x512xf32, 6xi64)
        t30 = paddle._C_ops.reshape(t29, t11)
        del t11, t29
        
        # pd_op.transpose: (-1x2x7x2x7x512xf32) <- (-1x2x2x7x7x512xf32)
        t31 = paddle._C_ops.transpose(t30, [0, 1, 3, 2, 4, 5])
        del t30
        
        # pd_op.reshape: (-1x14x14x512xf32) <- (-1x2x7x2x7x512xf32, 4xi64)
        t32 = paddle._C_ops.reshape(t31, t12)
        del t12, t31
        
        # pd_op.roll: (-1x14x14x512xf32) <- (-1x14x14x512xf32, 2xi64)
        ...
        # pd_op.reshape: (-1x196x512xf32) <- (-1x14x14x512xf32, 3xi64)
    ...
    def get_input_spec(self):
        return [
            # t0
            paddle.static.InputSpec(shape=[4, 1, 49, 49], dtype='float32'),
            # t1
            paddle.static.InputSpec(shape=[1], dtype='int64'),
            # t2
            paddle.static.InputSpec(shape=[None, 4, 16, 49, 49], dtype='float32'),
            # t3
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t6
            paddle.static.InputSpec(shape=[None, 16, 49, 32], dtype='float32'),
            # t7
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t8
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.uniform([4, 1, 49, 49], dtype='float32', min=0, max=0.5),
            # t1
            paddle.to_tensor([0], dtype='int64').reshape([1]),
            # t2
            paddle.uniform([64, 4, 16, 49, 49], dtype='float32', min=0, max=0.5),
            # t3
            ...
            # t6
            paddle.uniform([256, 16, 49, 32], dtype='float32', min=0, max=0.5),
            # t7
            ...
            # t10
            paddle.to_tensor([-1, 7, 7, 512], dtype='int64').reshape([4]),
            # t11
            paddle.to_tensor([-1, 2, 2, 7, 7, 512], dtype='int64').reshape([6]),
            # t12
            paddle.to_tensor([-1, 14, 14, 512], dtype='int64').reshape([4]),
            # t13
            paddle.to_tensor([3, 3], dtype='int64').reshape([2]),
            # t14
            paddle.to_tensor(64, dtype='int64').reshape([]),
            # t15
            paddle.to_tensor(196, dtype='int64').reshape([]),
        ]
