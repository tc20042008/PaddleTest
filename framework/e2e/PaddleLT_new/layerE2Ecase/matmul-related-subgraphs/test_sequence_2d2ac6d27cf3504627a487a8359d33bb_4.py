...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13):
        t0 = paddle._C_ops.full_int_array([32, 1, 1, 1], paddle.int64, paddle.core.CPUPlace())
    ...
    def get_input_spec(self):
        return [
            ...
            # t2
            paddle.static.InputSpec(shape=[32, 384, 14, 14], dtype='float32'),
            # t3
            paddle.static.InputSpec(shape=[32, 384, 14, 14], dtype='float32'),
            # t4
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            # t0
            paddle.to_tensor([32, 1, 1, 1], dtype='int64').reshape([4]),
            # t1
            paddle.to_tensor(0.9529410004615784, dtype='float32').reshape([]),
            # t2
            paddle.uniform([32, 384, 14, 14], dtype='float32', min=0, max=0.5),
            # t3
            paddle.uniform([32, 384, 14, 14], dtype='float32', min=0, max=0.5),
            # t4
