...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20):
        ...
        t19 = paddle._C_ops.full_int_array([-1, 12, 12, 384], paddle.int64, paddle.core.CPUPlace())
        t20 = paddle._C_ops.full_int_array([-1, 144, 384], paddle.int64, paddle.core.CPUPlace())
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        t21 = [t0, t1, t2]
        del t0
        
        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        t22 = paddle._C_ops.stack(t21, 0)
        del t21
        
        # pd_op.reshape: (-1x2304x384xf32) <- (-1x48x48x384xf32, 3xi64)
        t23 = paddle._C_ops.reshape(t3, t22)
        del t3, t22
        ...
        t25, t26, t27 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t24, t5, t6, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t6, t5
        ...
        t33 = paddle._C_ops.add(t24, t32)
        del t24, t32
        
        # pd_op.shape64: (3xi64) <- (-1x2304x384xf32)
        t34 = paddle._C_ops.shape64(t33)
        
        # pd_op.slice: (xi64) <- (3xi64, 1xi64, 1xi64)
        t35 = paddle._C_ops.slice(t34, [0], t11, t12, [1], [0])
        del t34
        
        # pd_op.layer_norm: (-1x2304x384xf32, -1x2304xf32, -1x2304xf32) <- (-1x2304x384xf32, 384xf32, 384xf32)
        t36, t37, t38 = (lambda x, f: f(x))(paddle._C_ops.layer_norm(t33, t13, t14, float('1e-05'), 2), lambda out: out if isinstance(out, (list, tuple)) else (out, None,None))
        del t14, t13
        ...
        t40 = paddle._C_ops.stack(t39, 0)
        del t39
        
        # pd_op.reshape: (-1x48x48x384xf32) <- (-1x2304x384xf32, 4xi64)
        t41 = paddle._C_ops.reshape(t36, t40)
        del t36, t40
        
        # pd_op.shape64: (4xi64) <- (-1x48x48x384xf32)
        t42 = paddle._C_ops.shape64(t41)
        
        # pd_op.slice: (xi64) <- (4xi64, 1xi64, 1xi64)
        t43 = paddle._C_ops.slice(t42, [0], t11, t12, [1], [0])
        del t42
        
        # pd_op.roll: (-1x48x48x384xf32) <- (-1x48x48x384xf32, 2xi64)
        t44 = paddle._C_ops.roll(t41, t16, [1, 2])
        del t41
        ...
        t52 = paddle._C_ops.reshape(t51, t20)
        del t20, t51
    ...
    def get_input_spec(self):
        return [
            ...
            paddle.static.InputSpec(shape=[], dtype='int64'),
            # t3
            paddle.static.InputSpec(shape=[None, 48, 48, 384], dtype='float32'),
            # t4
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t1
            paddle.to_tensor(2304, dtype='int64').reshape([]),
            # t2
            paddle.to_tensor(384, dtype='int64').reshape([]),
            # t3
            paddle.uniform([32, 48, 48, 384], dtype='float32', min=0, max=0.5),
            # t4
            paddle.uniform([32, 2304, 384], dtype='float32', min=0, max=0.5),
            # t5
            ...
            # t19
            paddle.to_tensor([-1, 12, 12, 384], dtype='int64').reshape([4]),
            # t20
            paddle.to_tensor([-1, 144, 384], dtype='int64').reshape([3]),
        ]
