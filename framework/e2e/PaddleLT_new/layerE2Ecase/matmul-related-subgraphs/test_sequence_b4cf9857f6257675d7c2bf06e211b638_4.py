...
class SubGraphLayer(InstanceTrait, paddle.nn.Layer):
    ...
    def forward(self, t0, t1, t2, t3, t4, t5, t6, t7):
        t1 = paddle._C_ops.full_int_array([2, 5376, 8, 32], paddle.int64, paddle.core.CPUPlace())
        # pd_op.reshape: (2x5376x8x32xf32) <- (2x5376x256xf32, 4xi64)
...
class TestSubGraphLayer(CinnTestBase, unittest.TestCase):
    ...
    def get_inputs(self):
        return [
            ...
            # t1
            paddle.to_tensor([2, 5376, 8, 32], dtype='int64').reshape([4]),
            # t2
